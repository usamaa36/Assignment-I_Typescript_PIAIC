...
*/
 function make_shirt(size:string, tshirtMessage:string)
 {
    console.log (` The tshirt size is ${size} and the T-shirt message is ${tshirtMessage}`);
 }

 make_shirt("large",'Fish the police');
